...
4. create/reuse the dedicated sibling worktree for `feat/d0-04-viewer` at the exact baseline according to `WORKTREE_EXECUTION.md`;
...
All implementation commits must be created inside the dedicated D0-04 worktree, never the shared entry repository.
